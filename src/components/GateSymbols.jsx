...
export const ANDGateSVG = ({ color = '#00f3ff', size = 40 }) => (
  <svg width={size} height={size * 0.6} viewBox="0 0 60 36" fill="none">
    <path
      ...
      fill="none"
    />
    <line x1="0" y1="9" x2="0" y2="27" stroke={color} strokeWidth="2" />
  </svg>
);

export const ORGateSVG = ({ color = '#bc13fe', size = 40 }) => (
...
export const NOTGateSVG = ({ color = '#ff00ff', size = 36 }) => (
...
export const NANDGateSVG = ({ color = '#00f3ff', size = 40 }) => (
  <svg width={size} height={size * 0.6} viewBox="0 0 60 36" fill="none">
    <path
...
export const NORGateSVG = ({ color = '#bc13fe', size = 40 }) => (
  <svg width={size} height={size * 0.65} viewBox="0 0 60 39" fill="none">
    <path
...
export const XORGateSVG = ({ color = '#00f3ff', size = 40 }) => (
  <svg width={size} height={size * 0.65} viewBox="0 0 60 39" fill="none">
    <path
...
export const XNORGateSVG = ({ color = '#bc13fe', size = 40 }) => (
  <svg width={size} height={size * 0.65} viewBox="0 0 60 39" fill="none">
    <path
